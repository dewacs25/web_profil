                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="" method="POST">
                                                    <input type="text" placeholder="Nama Keahlian" name="nama_skil" class="form-control">
                                                    <br>
                                                    <div class="input-group mb-3">
                                                        <input type="number" name="persentase" class=" w-25">
                                ...
                                <div class="table-responsive" style="min-height: 400px;">
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $sql = mysqli_query($koneksi, "SELECT * FROM `tb_skil` ORDER BY id_skil DESC");
                                            ...
                                            while ($row = mysqli_fetch_array($sql)) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="?id_hapus=<?= $row['id_skil']; ?>" onclick="return confirm('yakin ingin menghapus')" class="btn btn-danger badge">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
...
if (isset($_POST['tambah'])) {
    ...
    $id = $_GET['id_hapus'];
    $hapusSql = mysqli_query($koneksi,"DELETE FROM tb_skil WHERE id_skil='$id'");
    if ($hapusSql) {
        echo "<script>alert('hapus Berhasil');document.location='skil.php'</script>";
    }
}
?>