            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="" method="POST" autocomplete="off" enctype="multipart/form-data">
                  <input class="form-control" type="text" name="judul" placeholder="Masukan Judul Artikel" required autocomplete="off">
                  <br>
...
if (isset($_POST['input'])) {
  ...
  $sql = mysqli_query($koneksi, "INSERT INTO `tb_portofolio`(`id_portofolio`, `judul`, `text`, `gambar`, `tgl`) VALUES ('$ir','$judul','$isi','$newnama','$tgl')");
  if ($sql) {
